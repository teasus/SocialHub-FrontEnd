...
export const TWEET_DELETE_FAILURE = "TWEET_CREATE_FAILURE";
...
export const USER_LIKED_TWEET_REQUEST = "USER_LIKED_TWEET_REQUEST";
export const USER_LIKED_TWEET_SUCCESS = "USER_LIKED_TWEET_SUCCESS";
export const USER_LIKED_TWEET_FAILURE = "USER_LIKED_TWEET_FAILURE";
